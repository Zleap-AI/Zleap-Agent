      ...
      {suggestions.map((item, index) => {
        ...
        return (
          <button
            ...
            className="animate-msg-in group flex items-center gap-2.5 rounded-lg border border-border/80 bg-surface-2 px-3 py-2.5 text-left shadow-xs transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-border-strong hover:bg-muted/50 hover:shadow-sm"
          >
